...
f.write("Misconfigured XFrame Options: " + str(xframeCount))
f.write("XSS Protection: " + str(xssCount))
f.write("Misconfigured Access-Control-Allow-Origin: " + str(accessCount))
f.write("HSTS misconfiguration: " + str(hstsCount))
f.write("Misconfigured Server Header: " + str(serverCount))
f.close()
